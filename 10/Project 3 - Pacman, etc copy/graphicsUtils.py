...
def begin_graphics(width=0, height=480, color=formatColor(0, 0, 0), title=None):
...
def keys_pressed(d_o_e=lambda _: _root_window.dooneevent,
...
def remove_from_screen(x,
                       d_o_e=lambda _: _root_window.dooneevent,
                       d_w=tkinter._tkinter.DONT_WAIT):
    _canvas.delete(x)
    d_o_e(d_w)
